...
guard 'livereload' do
  extensions = {
    # css: :css, # see "Sprockets 3" below for CSS/JS rules
    # scss: :css,
    # sass: :css,
    # js: :js,
    html: :html,
  ...
  # Sprockets 3 adds ".self" to the path; these are the correct paths with
  # "config.assets.debug = true" and "config.assets.digest = false"
  #
