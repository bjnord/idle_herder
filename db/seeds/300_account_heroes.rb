...
account.account_heroes.create!(type: 'SpecificAccountHero', hero_id: hero.id, level: 0, shards: 40, is_fodder: true, target_stars: 5)
hero = Hero.find_by!(name: 'Iceblink', stars: 6)
account.account_heroes.create!(type: 'SpecificAccountHero', hero_id: hero.id, wish_list: true, level: 0, shards: 0, is_fodder: true, target_stars: 10)
